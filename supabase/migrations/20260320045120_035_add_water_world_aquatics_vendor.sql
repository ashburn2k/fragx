/*
  # Add Water World Aquatics Vendor

  Adds Water World Aquatics (waterworldaquatics.us) to the vendor scrape list.

  - Confirmed Shopify store
  - Coral collections: euphyllia, hammers, lps, mushrooms, soft-coral, sps, torches, wysiwyg, anemones
...
VALUES
  (
    'water-world-aquatics',
    'Water World Aquatics',
    'https://waterworldaquatics.us',
    'https://waterworldaquatics.us',
