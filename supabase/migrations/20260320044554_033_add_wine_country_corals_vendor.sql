/*
  # Add Wine Country Corals Vendor

  Adds Wine Country Corals (winecountrycorals.com) to the vendor scrape list.

  - Confirmed Shopify store
  - Coral collections: lps, sps, zoanthids-and-mushrooms, anemone, wysiwyg
...
VALUES
  (
    'wine-country-corals',
    'Wine Country Corals',
    'https://winecountrycorals.com',
    'https://winecountrycorals.com',
    ARRAY['lps', 'sps', 'zoanthids-and-mushrooms', 'anemone', 'wysiwyg'],
    ARRAY[]::text[],
    true,
    true
  )
