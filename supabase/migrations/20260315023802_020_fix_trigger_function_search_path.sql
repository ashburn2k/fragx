/*
  # Fix Mutable Search Path on trigger_weekly_vendor_scrape

  ## Summary
  Adds `SET search_path = public` to the `trigger_weekly_vendor_scrape` function
  to prevent search_path injection attacks. SECURITY DEFINER functions must have
  a fixed search_path to be safe.
*/
