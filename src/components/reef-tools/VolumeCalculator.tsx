  ...
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5">
      <div className="flex items-center gap-2 mb-4">
        ...
        <div>
          <h3 className="text-white font-semibold text-sm">Tank Volume</h3>
          <p className="text-slate-500 text-xs">Calculate your tank's capacity</p>
        </div>
      </div>
      ...
      <div className="space-y-3">
        {shape === 'cylinder' ? (
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-xs text-slate-400 mb-1 block">Diameter ({unit})</label>
          ...
          <div className="grid grid-cols-3 gap-3">
            <div>
              <label className="text-xs text-slate-400 mb-1 block">Length ({unit})</label>
        ...
        {shape === 'bowfront' && (
          <p className="text-xs text-slate-500">Bow-front volume estimated ~10% above rectangle</p>
        )}
      </div>
      ...
      {result && (
        <div className="mt-4 grid grid-cols-2 gap-3">
          <div className="bg-slate-800/60 rounded-xl p-3 text-center">
            ...
            <div className="text-xs text-slate-400 mt-0.5">US Gallons</div>
          </div>
          <div className="bg-slate-800/60 rounded-xl p-3 text-center">
            <div className="text-2xl font-bold text-teal-400">{result.lit.toFixed(1)}</div>
            <div className="text-xs text-slate-400 mt-0.5">Liters</div>
          </div>
        </div>
      )}
    </div>
