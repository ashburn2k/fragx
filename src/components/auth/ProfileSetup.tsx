      ...
      <div className="w-full max-w-lg">
        <div className="flex items-center gap-3 mb-8 justify-center">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm">Join the reef community</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-slate-900 border border-slate-700 rounded-2xl p-6 space-y-3">
            <h3 className="text-white font-semibold">I am a...</h3>
            {roles.map(({ value, label, desc, Icon }) => (
              ...
              >
                <div className={`w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 ${
                  role === value ? 'bg-cyan-500/20' : 'bg-slate-700'
                }`}>
                  <Icon size={18} className={role === value ? 'text-cyan-400' : 'text-slate-400'} />
                </div>
                <div>
          ...
          <div className="bg-slate-900 border border-slate-700 rounded-2xl p-6 space-y-4">
            <h3 className="text-white font-semibold">Location <span className="text-slate-500 font-normal text-sm">(optional)</span></h3>
